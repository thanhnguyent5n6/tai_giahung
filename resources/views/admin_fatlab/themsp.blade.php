              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                        <div class="clearfix">
                          <form action="{{ route('them-sp') }}" method="post" class="form-inline" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div class="col-md-9">
                                <input type="text" name="name" class="form-control" id="ten">
                              </div>
                            </div>
                            <div class="form-group col-md-4">
                              ...
                              <select class="form-control col-md-8" name="category" id="sel1">
                                @foreach($type as $t)
                                <option value="{{ $t->id }}">{{ isset($t->name)?$t->name:'' }}</option>
                                @endforeach
                              </select>
                            </div>
                            ...
                            <div class="form-group col-md-4" style="margin-top: 30px;">
                              ...
                              <div class="col-md-9">
                                <input type="number" name="unit_price" class="form-control" id="ma" >
                              </div>
                            </div>
                            <div class="form-group col-md-4" style="margin-top: 30px;">
                              <label class="col-md-3" for="ma">Giá khuyễn mãi:</label>
                              <div class="col-md-9">
                                <input type="number" name="promotion_price" class="form-control" id="ma">
                              </div>
                            </div>
                            <div class="form-group col-md-4" style="margin-top: 30px;">
                              <label class="col-md-4">Sản phẩm mới</label>&nbsp;&nbsp;<input name="new" type="checkbox"> <label for="new"></label>
                            </div>
