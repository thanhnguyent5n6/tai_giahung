              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                        <div class="clearfix">
                          <form action="{{ route('sua-tin-tuc',$news->id) }}" method="post" class="form-inline" enctype="multipart/form-data">
                            <input hidden="hidden" type="text" name="_token" value="{{ csrf_token() }}">
                            <div class="form-group col-md-4">
                              <label class="col-md-3" for="ma">Mã bài viết:</label>
                              <div class="col-md-9">
                                <input type="ma" class="form-control" id="ma" disabled="disabled" value="{{ isset($news->id)?$news->id:'' }}">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <textarea id="title" name="title">{{ isset($news->title)?$news->title:'' }}</textarea>
                            ...
                            <div class="form-group">
                              ...
                              <textarea id="content" name="content">{{ isset($news->content)?$news->content:'' }}</textarea>
                                <script type="text/javascript">
